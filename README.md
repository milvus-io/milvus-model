...
`milvus-model` supports embedding and reranker models from service providers like OpenAI, Voyage AI, Cohere, Jina AI, and TypeSafe (Jev), and open-source models through SentenceTransformers or Hugging Face [Text Embeddings Inference (TEI)](https://github.com/huggingface/text-embeddings-inference) .
