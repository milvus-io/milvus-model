#The following code is adapted from/inspired by the 'instructor-embedding' project:
#https://github.com/xlang-ai/instructor-embedding
#Specifically, instructor-embedding/InstructorEmbedding/instructor.py
#
# License: Apache License 2.0 (January 2004)
#
# For more information on the original project, visit the GitHub repository:
# https://github.com/xlang-ai/instructor-embedding
#
